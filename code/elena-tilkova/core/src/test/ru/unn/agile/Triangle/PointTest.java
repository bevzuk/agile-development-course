...
public class PointTest
{
    ...
    @Test
    public void isCollinearPointsCollinear()
    {
        Point point1 = new Point(2, 0);
        Point point2 = new Point(0, 2);
        Point point3 = new Point(1, 1);
        assertEquals(true, point1.collinear(point2, point3));
    }

    @Test
    public void isNotCollinearPointsNotCollinear()
    {
        Point point1 = new Point(2, 0);
        Point point2 = new Point(0, 2);
        Point point3 = new Point(0, 0);
        assertEquals(false, point1.collinear(point2, point3));
    }

    @Test
    public void isTwoEqualPointsCollinear()
    {
        Point point1 = new Point(2, 0);
        Point point2 = new Point(2, 0);
        Point point3 = new Point(0, 0);
    ...
    @Test
    public void isThreeEqualPointsCollinear()
    {
        Point point1 = new Point(2, 0);
        Point point2 = new Point(2, 0);
